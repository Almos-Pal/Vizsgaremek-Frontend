    ...
    <ContentLayout header={data.gyakorlat_neve}>
      <div>
        <div className={styles.linksContainer}>
          ...
          <Button
            color="secondary"
            href={`/edzesek?gyakorlat_id=${data.gyakorlat_id}`}
          >
            Edzés előzmények
          </Button>
        ...
        <div className={styles.linksContainerMobile}>
          ...
          <Link href={`/edzesek?gyakorlat_id=${data.gyakorlat_id}`}>
            Edzés előzmények
          </Link>
        ...
        <div className={styles.containerWIcon}>
          <Button
            ...
            color="secondary"
            width={"40px"}
            additionalClassName={styles["back-button-mobile"]}
            style={{
              borderRadius: "50%",
              width: "30px",
              height: "40px",
          ...
          {isOfAdminHeritageUser && (
            <div className={styles.editButton}>
              <Button
                ...
                leftIcon={"EditIcon"}
                width={36}
                iconProps={{ size: 36, color: "var(--color-grey-100)" }}
                noBackground
                color="primary"
                href={`/gyakorlatok/${data.gyakorlat_id}/szerkeszt`}
              ></Button>
            </div>
          )}
          ...
          <div className={styles.dataContainer}>
            <div className={styles.content}>
              ...
              <div className={styles.description}>
                <Text variant="subtitle-16">Gyakorlat leírása :</Text>
                <Text className={styles.descriptionText} variant="body-16">
                  {data.gyakorlat_leiras}
                </Text>
              </div>
            </div>
            <div className={styles.svgContainer}>
              <div className={styles.svgHeader}>
                <div className={styles.svgText}>
                  <Text variant="subtitle-16" className="w-[120px]">
                    Elsődleges izom
                  </Text>
                  <div className={styles.primary}></div>
                </div>
                <div className={styles.svgText}>
                  <Text variant="subtitle-16" className="w-[150px]">
                    Másodlagos izmok
                  </Text>
              ...
              <div className={styles.svg}>
                <BodySVG
                  size={300}
                  selectedMuscleIds={[data.fo_izomcsoport]}
                  secondaryMuscleIds={data.izomcsoportok}
                />
              </div>
            </div>
          </div>
