...
function TodaysWorkout() {
    ...
    return (
        //<div id="mainDiv" className= "max-w-[496] max-h-[388] bg-color-grey-500">
        /*
            ...
            <div className="max-w-[496px]  max-h-[285px] flex flex-row basis-full gap-2 p-0">
                ...
                <div className="mr-6">

                    {
                        list.map((item) => {
                            return (
                                <div key={item.name} className="solid max-h-[22.77px] flex flex-row mt-0 mb-6 p-0  ">
                                    ...
                                    <div className="flex flex-row max-w-[105px]  ml-0 w-full">
                                        <div className=" w-full sm:text-right">
                                            <Text variant="body-16" >{item.sets}*{item.reps}</Text>
                                        </div>
                                    </div >
                                </div>
...
</div>
{
    ...
    ||
    <div className="">
        <Button width={"100%"} color={"secondary"} >Gyakorlatok</Button></div>
}

</div>
    <div className={clsx(styles.humanDiv, "max-w-[162px] max-h-[285px] min-w-[129px]  flex-row basis-1//3 ml-0 rounded-lg mr-4 ")}>
