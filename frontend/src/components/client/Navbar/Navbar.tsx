  ...
  return (
    <>
      ...
      <nav className={styles.desktopnavbar}>
        <IconButton icon="HomeIcon" color="transparent" iconProps={{ size: 40 }} />
        <IconButton icon="ProfileIcon" color="transparent" iconProps={{ size: 50 }} />
        <IconButton
          icon="AddIcon"
          color="secondary"
          iconProps={{ size: 60 }}
      ...
      <nav className={styles.mobilenavbar}>
        ...
        <div className={styles.navItem}>
          <IconButton icon="LogoutIcon" color="transparent" iconProps={{ size: 30 }} />
          <Text variant="caption" color="var(--color-grey-300)">
            Kilépés
          </Text>
        </div>
