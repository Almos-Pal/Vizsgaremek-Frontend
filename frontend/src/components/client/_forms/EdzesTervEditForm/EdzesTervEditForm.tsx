                                                        ...
                                                        },
                                                        {
                                                            onSuccess: (returnedGyakorlat) => {
                                                                arrayHelpers.push({
                                                                    ...
                                                                    eszkoz: returnedGyakorlat.eszkoz || "",  // ADD THIS
                                                                    fo_izomcsoport: returnedGyakorlat.fo_izomcsoport || 0, // ADD THIS
                                                                    izomcsoportok: returnedGyakorlat.izomcsoportok || [], // ADD THIS
