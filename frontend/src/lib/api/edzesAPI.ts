...
const edzesAPI = {
  fetchEdzesek: async ({
    ...
    orderBy,
    token,
  }: FetchEdzesekParams & { token?: string } = {}): Promise<
    PaginatedResponse<Edzes>
  > => {
  ...
  fetchEdzes: async (id: number, token?: string): Promise<Edzes> => {
    const response = await fetch(`${BACKEND_URL}/edzes/${id}`, {
      headers: {
        "Content-Type": "application/json",
        ...(token ? { Authorization: `Bearer ${token}` } : {}),
      },
  ...
  createEdzes: async (newEdzes: any, token?: string) => {
    const response = await fetch(`${BACKEND_URL}/edzes`, {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
        ...(token ? { Authorization: `Bearer ${token}` } : {}),
  ...
  addGyakorlatToEdzes: async (
    ...
    const response = await fetch(
      `${BACKEND_URL}/edzes/${edzesId}/gyakorlat/${userId}`,
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
  ...
  deleteGyakorlatFromEdzes: async (
    edzesId: number,
    gyakorlatId: number,
    userId: number,
    token?: string
    ...
    const response = await fetch(
      `${BACKEND_URL}/edzes/${edzesId}/gyakorlat/${gyakorlatId}/${userId}`,
      {
        method: "DELETE",
        headers: {
          "Content-Type": "application/json",
  ...
  addSetToGyakorlatInEdzes: async (
    edzes_id: number,
    gyakorlatId: number,
    userId: number,
    ...
    const response = await fetch(
      `${BACKEND_URL}/edzes/${edzes_id}/gyakorlat/${gyakorlatId}/set/${userId}`,
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
  ...
  updateSetInGyakorlatInEdzes: async (
    ...
    const response = await fetch(
      `${BACKEND_URL}/edzes/${edzes_id}/gyakorlat/${gyakorlatId}/set/${setId}/${userId}`,
      {
        method: "PATCH",
        headers: {
          "Content-Type": "application/json",
  ...
  createEdzesTemplate: async (
    ...
    const response = await fetch(
      `${BACKEND_URL}/edzes/template/${templateId}/${userId}`,
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
  ...
  changeEdzesFinalizedStatus: async (
    edzesId: number,
    userId: number,
    finalized: boolean,
    token?: string
    ...
    const response = await fetch(
      `${BACKEND_URL}/edzes/${edzesId}/finalize/${userId}`,
      {
        method: "PATCH",
        headers: {
          "Content-Type": "application/json",
  ...
  fetchEdzesIntervallum: async (
    ...
    const response = await fetch(
      `${BACKEND_URL}/edzes/intervallum?user_id=${userId}&startDate=${startDate}&endDate=${endDate}`,
      {
        headers: {
          "Content-Type": "application/json",
          ...(token ? { Authorization: `Bearer ${token}` } : {}),
  ...
  fetchTenDays: async (userId: number, gyakorlat: number, token?: string) => {
    const response = await fetch(
      `${BACKEND_URL}/edzes/ten?userId=${userId}&gyakorlat=${gyakorlat}`,
      {
        headers: {
          "Content-Type": "application/json",
          ...(token ? { Authorization: `Bearer ${token}` } : {}),
  ...
  fetchEdzesekChosenDate: async (
    ...
    const response = await fetch(`${BACKEND_URL}/edzes/intervallum?${query}`, {
      headers: {
        "Content-Type": "application/json",
        ...(token ? { Authorization: `Bearer ${token}` } : {}),
      },
  ...
  fetchCurrentWeek: async (userId: number, token?: string) => {
    const response = await fetch(
      `${BACKEND_URL}/edzes/current-week/${userId}`,
      {
        headers: {
          "Content-Type": "application/json",
          ...(token ? { Authorization: `Bearer ${token}` } : {}),
  ...
  findOneByDate: async (userId: number, date: string, token?: string) => {
    const response = await fetch(
      `${BACKEND_URL}/edzes/napi?userId=${userId}&date=${date}`,
      {
        headers: {
          "Content-Type": "application/json",
          ...(token ? { Authorization: `Bearer ${token}` } : {}),
